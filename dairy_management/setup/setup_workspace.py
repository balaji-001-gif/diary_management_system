"""
One-time script to insert/update the Dairy Management workspace.
Run with:
    bench --site dairy.aimaxl.com execute dairy_management.setup.setup_workspace.execute
Or as a standalone console script:
    bench --site dairy.aimaxl.com console
    then paste and run the content of this file.
"""
